...
public class IncomeTranCommonScreen extends JPanel {

	private static final long serialVersionUID = 1L; 

	JPanel topPanel;
	JPanel bottomPanel;
	IncomeTranScreen incomeAddScreen;
	IncomeTranViewScreen incomeViewScreen;
	IncomeTranEditScreen incomeEditScreen;
	...
	public RkButton getBtnSave() {
		return btnSave;
	}


	public IncomeTranCommonScreen() {
	...
	public void createMenus() {
		...
		incomeAddScreen = new IncomeTranScreen();
		incomeAddScreen.setLayout(null);
		incomeAddScreen.setVisible(false);
		add(incomeAddScreen);
		
		incomeEditScreen = new IncomeTranEditScreen();
		incomeEditScreen.setLayout(null);
		incomeEditScreen.setVisible(false);
		add(incomeEditScreen);
		
		incomeViewScreen = new IncomeTranViewScreen();
