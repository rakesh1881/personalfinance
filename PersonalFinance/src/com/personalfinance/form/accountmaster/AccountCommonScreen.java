...
public class AccountCommonScreen extends JPanel {

	private static final long serialVersionUID = 1L; 

	JPanel topPanel;
	JPanel bottomPanel;
	AccountAddScreen accountAddScreen;
	...
	public void createMenus() {
		...
		accountAddScreen = new AccountAddScreen();
		accountAddScreen.setLayout(null);
		accountAddScreen.setVisible(false);
		add(accountAddScreen);
		
		accountEditScreen = new AccountEditScreen();
		accountEditScreen.setLayout(null);
		accountEditScreen.setVisible(false);
		add(accountEditScreen);
		
		accountViewScreen = new AccountViewScreen();
